...
You can run a local dev server with Bun to serve this repository:

- Prerequisite: Install Bun from https://bun.sh (macOS/Linux/Windows WSL)

Options:

1) Hot-reload server (auto-restarts on server.ts changes)
